        ...
        children={
          <div className="w-full max-w-6xl">
            <div className="columns-1 gap-6 space-y-6 md:columns-2 lg:columns-3">
              ...
              <div className="glass-effect group relative break-inside-avoid rounded-2xl border border-white/10 p-6 transition-all duration-300 hover:border-white/40">
              ...
              <div className="glass-effect group relative break-inside-avoid rounded-2xl border border-white/10 p-6 transition-all duration-300 hover:border-white/40">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <TechItem title="Tailwind" href="https://tailwindcss.com/">
